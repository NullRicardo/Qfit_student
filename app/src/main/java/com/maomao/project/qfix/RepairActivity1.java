...
public class RepairActivity1 extends Activity implements OnItemClickListener,
		SwipeRefreshLayout.OnRefreshListener {

	@SuppressWarnings("unused")
	private static final String TAG = "RepairActivity1";
	...
	private void queryData(final int page, final int actionType){
		...
		//query.addWhereEqualTo("title","ccmou");
		//query.order("topic");
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
			long id) {
		Intent toShopItem = new Intent(RepairActivity1.this, RepairMainActivity.class);
